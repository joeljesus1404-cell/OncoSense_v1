...
with st.sidebar:
    ...
    page = st.radio(
        "Navigation",
        ["🏠 Home", "🔬 Start Diagnosis", "📊 Model Analytics", "ℹ️ About"],
...
if page == "🏠 Home":
    ...
    with col2:
        display_metric_card("Input Features", "30", suffix=" tumor metrics")
    with col3:
        display_metric_card("Quantum Qubits", "4", suffix=" qubits")
    with col4:
        display_metric_card("Model Types", "3", suffix=" classifiers")
    ...
    with col1:
        ...
        **🧪 Quantum Kernel Classification**
        ...
        OncoSense uses a **Quantum Kernel SVM** — replacing classical kernel functions
        with quantum circuits that map biopsy data into high-dimensional Hilbert space.

        The pipeline:
        1. **ZZFeatureMap** encodes 4 PCA features into quantum states |ψ(x)⟩
        2. **Fidelity Quantum Kernel** computes K(x,x') = |⟨ψ(x)|ψ(x')⟩|²
        3. **SVC Classifier** finds optimal hyperplane in quantum kernel space

        This captures non-linear correlations that classical RBF kernels cannot
    ...
    with col2:
        ...
        **🏥 Clinical Workflow**
        ...
        1. **Input**: Enter 30 standard tumor measurements from biopsy report
        ...
        **Cost**: Near-zero per prediction vs ₹5,000-50,000 for traditional cycles.
    ...
    with col1:
        ...
        <div class="metric-card">
            ...
            <div style="color: #ccc; margin-top: 0.5rem; font-size: 0.9rem;">
                ...
                UCI Wisconsin Dataset<br>
                Quantum vs Classical SVM<br>
